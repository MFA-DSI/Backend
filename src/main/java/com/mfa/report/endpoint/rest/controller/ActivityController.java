...
public class ActivityController {
    ...
    public List<Activity> getActivitiesForWeek(@RequestParam LocalDate weekStartDate, @RequestParam String directionId) {
        return activityService.getActivitiesForWeek(weekStartDate, directionId);
    }

    @GetMapping("/activities/month")
    public List<Activity> getActivitiesForMonth(@RequestParam int year, @RequestParam int month, @RequestParam String directionId) {
        return activityService.getActivitiesForMonth(year, month, directionId);
    }

    @GetMapping("/activities/quarter")
    public List<Activity> getActivitiesForQuarter(@RequestParam int year, @RequestParam int quarter, @RequestParam String directionId) {
